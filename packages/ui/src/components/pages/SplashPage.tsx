...
import { TextCycler } from "@immersive-lang/ui/components/molecules";
    ...
    return (
      ...
      `}</style>
            ...
            <div className="absolute bottom-6 left-0 right-0 text-xs opacity-50 max-w-[600px] mx-auto leading-relaxed text-center px-4 z-10">
                <strong>Disclaimer:</strong> This application is for demo purposes only. This is not an official
                product. May produce inaccurate, unexpected, or offensive results. Present to a live audience at your
                own risk.
            </div>
        </div>
    );
