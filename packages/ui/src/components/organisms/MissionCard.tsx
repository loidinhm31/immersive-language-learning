...
import { Card } from "@immersive-lang/ui/components/atoms";
import { Badge } from "@immersive-lang/ui/components/atoms";
...
export function MissionCard({ mission, onClick }: MissionCardProps) {
    ...
    return (
        ...
        >
            ...
            <h3 className="m-0 mb-2 text-xl leading-tight font-heading font-bold text-text-main">{mission.title}</h3>
