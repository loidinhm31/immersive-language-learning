...
export function SessionDurationSelector({ value, onChange, className }: SessionDurationSelectorProps) {
    return (
            ...
            <div className="grid grid-cols-3 gap-3">
                {DURATION_OPTIONS.map((option) => {
                    ...
                    return (
                        ...
                        >
                            <Clock className={cn("w-5 h-5", isActive ? "text-accent-primary" : "text-text-sub")} />
                            <div>
                                <div
                                    className={cn(
                                        "font-bold text-base",
